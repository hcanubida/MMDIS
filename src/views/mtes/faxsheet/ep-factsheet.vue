      ...
      <table class="ftable">
        <tbody class="fbody">
          <tr v-for="(detail, index) in details" :key="index">
            <td style="padding-right: 30px;padding-left: 10px; letter-spacing: 3px;font-size: 12px;font-weight: 700;">
              NAME OF APPLICANT:
            </td>
          ...
          <tr v-for="(detail, index) in details" :key="index">
            ...
            <td
              ...
              Asperiores facere qui non alias. Unde consequuntur distinctio est sint. Rerum
              voluptatem qui
              voluptates laborum.
            </td>
          </tr>
        ...
        <tbody class="fbody">
          ...
          <tr>
            <td
              ...
              Articles of Incorporation/Partnership/ Association and By-Laws; or a Certification from MGB CO/RO
              concerned
  ...
  methods: {
    async fetchDetails() {
      ...
      try {
        ...
        this.details = response.data.filter(det => det.id == this.$route.params.detail_id1);
      } catch (error) {
