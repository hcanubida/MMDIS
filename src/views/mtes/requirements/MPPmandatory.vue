        ...
        <table class="table5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: left;width: 400px;">
                        <label>Remarks:</label><br>
                        <textarea class="textarea5" v-model="remarks.textInput12" style="height: 600px;"></textarea>
                        <label>Recommendation or Lacking Submission :</label><br>
                        <textarea class="textarea5" style="color: red;height: 600px;"
        ...
        <table class="table5">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left;width: 400px;">
                        <label>Remarks:</label><br>
                        <textarea class="textarea5" v-model="remarks.textInput13" style="height: 600px;"></textarea>
                        <label>Recommendation or Lacking Submission :</label><br>
                        <textarea class="textarea5" style="color: red;height: 600px;"
                ...
                <tr>
                    ...
                    <td style="text-align: left;width: 400px;">
                        <label>Remarks:</label><br>
                        <textarea class="textarea5" v-model="remarks.textInput14" style="height: 600px;"></textarea>
                        <label>Recommendation or Lacking Submission :</label><br>
                        <textarea class="textarea5" style="color: red;height: 600px;"
                ...
                <tr>
                    ...
                    <td style="text-align: left;width: 400px;">
                        <label>Remarks:</label><br>
                        <textarea class="textarea5" v-model="remarks.textInput15" style="height: 600px;"></textarea>
                        <label>Recommendation or Lacking Submission :</label><br>
                        <textarea class="textarea5" style="color: red;height: 600px;"
                ...
                <tr>
                    ...
                    <td style="text-align: left;width: 400px;">
                        <label>Remarks:</label><br>
                        <textarea class="textarea5" v-model="remarks.textInput16" style="height: 600px;"></textarea>
                        <label>Recommendation or Lacking Submission :</label><br>
                        <textarea class="textarea5" style="color: red;height: 600px;"
                ...
                <tr>
                    ...
                    <td style="text-align: left;width: 400px;">
                        <label>Remarks:</label><br>
                        <textarea class="textarea5" v-model="remarks.textInput17" style="height: 600px;"></textarea>
                        <label>Recommendation or Lacking Submission :</label><br>
                        <textarea class="textarea5" style="color: red;height: 600px;"
    ...
    methods: {
        ...
        async getDetails() {
            ...
            try {
                ...
                const filteredmtsr = mtsr.data.find(req => req.id_reference === parseInt(this.$route.params.detail_id5));
                const filteredoverall = overallstatus.data.find(req => req.id_reference === parseInt(this.$route.params.detail_id5));
            ...
            try {
                ...
                const uploadsrequirements = uploads.data.filter(req => req.id_reference == this.$route.params.detail_id5);
            ...
            try {
                ...
                const imagesrequirements = images.data.filter(req => req.id_reference == this.$route.params.detail_id5);
                ...
                // Initialize uploadFiles object for file1 to file5
                for (let i = 1; i <= 17; i++) { //<------pila kabuok
                    const key = `file${i}`;
                    this.imagesfile[key] = [];
                }
        ...
        update() {
            ...
            formData4.append('id_reference', this.$route.params.detail_id5);
            ...
            axios.post(`http://127.0.0.1:8000/update_images/${this.$route.params.detail_id5}`, formData4)
                .then(response => {
            ...
            // Send FormData to server using axios
            axios.post(`http://127.0.0.1:8000/update_uploads/${this.$route.params.detail_id5}`, formData3)
                .then(response => {
