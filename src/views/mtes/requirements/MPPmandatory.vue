...
export default {
    ...
    methods: {
        ...
        update() {
            ...
            axios.post(`${API_BASE_URL}/update_mtsrstatus/${this.$route.params.detail_id5}`, formData)
                .then(response => {
                    // Handle response
            ...
            axios.post(`${API_BASE_URL}/update_remarks/${this.$route.params.detail_id5}`, formData1)
                .then(response => {
            ...
            axios.post(`${API_BASE_URL}/update_recommendation/${this.$route.params.detail_id5}`, formData2)
                .then(response => {
            ...
            axios.post(`${API_BASE_URL}/update_images/${this.$route.params.detail_id5}`, formData4)
                .then(response => {
            ...
            // Send FormData to server using axios
            axios.post(`${API_BASE_URL}/update_uploads/${this.$route.params.detail_id5}`, formData3)
                .then(response => {
