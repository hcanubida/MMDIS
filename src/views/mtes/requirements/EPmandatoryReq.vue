<template>
  ...
  <div class="requirements">
    ...
    <div class="requirements">
      ...
      <!-- Table 2 -->
      <table class="table2">
        <caption style="text-align: left;font-size: 20px;font-weight: 600; padding-top: 20px;">Summary of Lacking Requirements</caption>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td>
              8. Proof of financial capability to undertake the implementation of the activities under the work programs:<br> &nbsp;
                  * Latest Audited Financial Statement and/or Annual Report for the preceding Year <br>&nbsp;
                  * Credit lines and/or certification/s of bank guarantee/deposit and/or similar negotiable instruments
              <label style="font-size: 20px;font-weight: 600;">STATUS:</label>
            </td>
