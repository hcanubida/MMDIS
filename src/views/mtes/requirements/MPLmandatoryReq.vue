    ...
    methods: {
        ...
        async getDetails() {
            ...
            try {
                ...
                const imagesrequirements = images.data.filter(req => req.id_reference == this.$route.params.detail_id8);
        ...
        update() {
            ...
            axios.post(`${API_BASE_URL}/update_mtsrstatus/${this.$route.params.detail_id8}`, formData)
                .then(response => {
                    // Handle response
            ...
            axios.post(`${API_BASE_URL}/update_remarks/${this.$route.params.detail_id8}`, formData1)
                .then(response => {
            ...
            axios.post(`${API_BASE_URL}/update_recommendation/${this.$route.params.detail_id8}`, formData2)
                .then(response => {
            ...
            formData4.append('id_reference', this.$route.params.detail_id8);
            ...
            axios.post(`${API_BASE_URL}/update_images/${this.$route.params.detail_id8}`, formData4)
                .then(response => {
