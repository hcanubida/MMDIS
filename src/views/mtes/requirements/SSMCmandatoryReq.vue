...
export default {
    ...
    methods: {
        ...
        onFileSelect(event) {
            ...
            axios.post(`${API_BASE_URL}/update_mtsrstatus/${this.$route.params.detail_id7}`, formData)
                .then(response => {
                    // Handle response
            ...
            axios.post(`${API_BASE_URL}/update_remarks/${this.$route.params.detail_id7}`, formData1)
                .then(response => {
            ...
            axios.post(`${API_BASE_URL}/update_recommendation/${this.$route.params.detail_id7}`, formData2)
                .then(response => {
            ...
            axios.post(`${API_BASE_URL}/update_images/${this.$route.params.detail_id7}`, formData4)
                .then(response => {
            ...
            // Send FormData to server using axios
            axios.post(`${API_BASE_URL}/update_uploads/${this.$route.params.detail_id7}`, formData3)
                .then(response => {
