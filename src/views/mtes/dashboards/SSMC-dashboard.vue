<template>
    ...
    <div class="">
      ...
      <!-- Text -->
      <div class="textz">
        <p class="text1">Small-Scale Mining Contract</p>
        <h2 class="text2">
          SUMMARY
        </h2>
      </div>
      ...
      <div v-if="viewDetail7">
        <viewdetail2 :detail_id7="detail_id7" />
      </div>
  ...
  const detail_id7 = ref('')
  const addDetail7 = ref(false)
  const detailToggle7 = () => {
  ...
  const viewToggle7 = () => {
    viewDetail7.value = true
  };
  
  export { addDetail7, detailToggle7, viewDetail7, viewToggle7, detail_id7 }
