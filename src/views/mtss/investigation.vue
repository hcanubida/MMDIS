    ...
    <div>
      ...
      <div class="flex justify-between mt-8">
        ...
        <div class="flex w-2/5 ml-2">
          ...
          <!-- Search Input Field -->
          <input v-model="searchQuery" @input="debouncedSearch" type="search" id="default-search" class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-r-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search MGB Mining Related Complaints/Casesacted Upon ..." required />
        </div>
        <!-- Add Button -->
