...
<div class="team-container" style="margin-top: 170px;">
    <div style="display: flex;text-align: center;width: 100%;align-items: center;flex-direction: column;">
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: center;">
            <div class="container">
                <div class="flex w-full justify-center">
                    <div class="personnel">
                        <img src="../assets/personnel/Furog.png" class="image" style="">
                        <h3 class="h3-text">Janice B. Furog</h3>
                        <p style="color: white; text-align: center;">Engineer V</p>
                        <p style="color: white; text-align: center;">Chief Division</p>
                    </div>
                </div>

                <div class="flex w-full justify-center mt-2">
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Administrative Aide III</p>
                    </div>
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Driver</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-v2">
                <div class="flex w-full justify-center">
                    <div class="flex m-2 w-44 justify-center flex-col p-1 rounded-t-full" style="background: linear-gradient(to top, #e6b980, #eacda3, #e6b980);">
                        <img src="../assets/personnel/Orteza.jpg" class="image-v3" style="">
                        <p class="text-sm text-gray-900 text-center dark:text-white font-bold">Maria Raniela P. Orteza</p>
                        <p class="text-sm text-gray-50 text-center dark:text-white">Engineer IV</p>
                        <p class="text-sm text-gray-50 text-center dark:text-white">Section Chief, MTES</p>
                    </div>
                </div>
                ...
                <div class="flex w-full justify-center mt-2">
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Mining Claims Examiner III</p>
                    </div>
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Engineer II</p>
                    </div>
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Mining Claims Examiner II</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-v2">
                <div class="flex w-full justify-center">
                    <div class="flex m-2 w-44 justify-center flex-col p-1 rounded-t-full" style="background: linear-gradient(to top, #e6b980, #eacda3, #e6b980);">
                        <img src="../assets/personnel/LIGAS.png" class="image-v3" style="">
                        <p class="text-base text-gray-900 text-center dark:text-white font-bold">Ralph John Ligas</p>
                        <p class="text-sm text-gray-50 text-center dark:text-white">Engineer IV</p>
                        <p class="text-sm text-gray-50 text-center dark:text-white">Section Chief, MTSS</p>
                    </div>
                </div>
                <div class="flex w-full justify-center mt-2">
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                    ...
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Economist II</p>
                    </div>
                    <div class="flex m-0 w-32 justify-start flex-col p-1">
                        ...
                        <p class="text-xs text-gray-500 text-center dark:text-white">Engineer</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-v2">
            <div class="flex w-full justify-center">
                <div class="flex m-2 w-44 justify-center flex-col p-1 rounded-t-full" style="background: linear-gradient(to top, #e6b980, #eacda3, #e6b980);">
                    <img src="../assets/personnel/Paulma.png" class="image-v3" style="">
                    <p class="text-sm text-gray-900 text-center dark:text-white font-bold">Gaudencio L. Paulma, Jr.</p>
                    <p class="text-sm text-gray-50 text-center dark:text-white">Engineer IV</p>
                    <p class="text-sm text-gray-50 text-center dark:text-white">Section Chief, MLSS</p>
                </div>
            </div>
            <div class="flex w-full justify-center mt-2">
                <div class="flex m-0 w-32 justify-start flex-col p-1">
                    ...
                    <p class="text-xs text-gray-500 text-center dark:text-white">Engineer III</p>
                </div>
                <div class="flex m-0 w-32 justify-start flex-col p-1">
                    ...
                    <p class="text-xs text-gray-500 text-center dark:text-white">Cartographer II</p>
                </div>
                <div class="flex m-0 w-32 justify-start flex-col p-1">
                    ...
                    <p class="text-xs text-gray-500 text-center dark:text-white">Geologic Aide</p>
                </div> 
                <div class="flex m-0 w-32 justify-start flex-col p-1">
                    ...
                    <p class="text-xs text-gray-500 text-center dark:text-white">GIS Specialist B</p>
                </div>
            </div>
        </div>
