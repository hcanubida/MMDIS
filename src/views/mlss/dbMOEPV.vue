  ...
  <div>
    ...
    <div class="mt-8">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr v-for="(moep, index) in filteredMOEP" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
      ...
      <div v-if="filteredMOEP.length === 0" class="text-center mt-4 text-gray-600 dark:text-gray-300">
        No results found.
      </div>
    </div>
