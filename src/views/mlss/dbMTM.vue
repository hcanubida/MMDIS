<template>
    <div>
      ...
      <div class="flex flex-col mt-44 justify-center font-bold text-center">
        <h1 class="text-4xl">Mining Tenement Maps</h1>
      </div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" class="px-6 py-3 cursor-pointer" @click="sortByDate('date_issuance')">
                Date of Issuance
                <span v-if="sortKey === 'date_issuance'" aria-label="Sorted ascending">
              ...
              <th scope="col" class="px-6 py-3 cursor-pointer" @click="sortByDate('date_validation')">
                Date of Validation
                <span v-if="sortKey === 'date_validation'" aria-label="Sorted ascending">
                  <template v-if="sortOrder === 'asc'">▲</template>
                  <template v-else>▼</template>
                </span>
              </th>
          ...
          <tbody>
            <tr v-for="(entry, index) in filteredEntries" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td class="px-6 py-4">
                <button class="bg-red-500 text-white px-2 py-1 rounded">View</button>
              </td>
            </tr>
          </tbody>
        </table>
