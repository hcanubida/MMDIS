<template>
  ...
  <div class="">
    ...
    <div class="flex flex-col mt-18 justify-center font-bold text-center">
        <h1 class="text-4xl">Mineral Production Sharing Agreement</h1>
...
import viewdetail from '../../../views/asChief/modal_details/MPSA-details.vue'
import Header from '../../../components/header.vue'
import Pie from '../../../components/MTES/charts/Pie.vue'
import BarChart from '../../../components/MTES/charts/bar.vue'
import Tableview from '../../asChief/tables/MPSA-table.vue'
