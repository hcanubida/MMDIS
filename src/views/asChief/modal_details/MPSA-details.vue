<template>
    <div class="fixed inset-0 flex items-center justify-center z-10">
        ...
        <div class="relative rounded-2xl p-5 bg-zinc-100 w-full max-w-lg mx-4">
            ...
            <div class="flex justify-center mt-8 gap-4">
                <button @click="navigateToMandatoryReqMPSA(detail_id)" class="w-auto px-4 py-2 bg-green-800 text-white rounded-md hover:bg-green-300 hover:text-black">Next</button>
  ...
  <script>
  import { viewDetail } from '../../../../views/mtes/dashboards/MPSA-dashboard.vue';
  ...
  export default { 
    ...
    methods: {
        ...
        navigateToMandatoryReqMPSA(detail_id) {
