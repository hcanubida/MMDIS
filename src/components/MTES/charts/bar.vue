  ...
  <div class="container1">
    ...
    <div class="bartable1">
      ...
      <div class="box">
        ...
        <Bar id="my-chart-id" :options="chartOptions" :data="chartData6" />
      </div>


      <div class="box">
        <h1>Iligan City</h1>
        <Bar id="my-chart-id" :options="chartOptions" :data="chartData7" />
      </div>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      chartData1: {
        ...
        datasets: [
          {
            backgroundColor: ['#A79277', '#EAD8C0', '#D1BB9E', '#FFF2E1',],
            data: [40, 20, 70, 10]
          }
        ]
      },
