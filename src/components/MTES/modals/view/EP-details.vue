    ...
    <div class="fixed inset-0 flex items-center justify-center z-10">
        ...
        <div class="relative rounded-2xl p-5 bg-zinc-100 w-full max-w-lg mx-4">
            ...
            <div class="flex justify-center mt-8 gap-4">
                <button @click="navigateToMandatoryReqEP(detail_id1)" class="w-auto px-4 py-2 bg-green-800 text-white rounded-md hover:bg-green-300 hover:text-black">Next</button>
  ...
  export default { 
    ...
    methods: {
        ...
        navigateToMandatoryReqEP(detail_id1) {
            window.location.href = `/MandatoryRequirements/${detail_id1}`;
        },
    }
  }
  </script>