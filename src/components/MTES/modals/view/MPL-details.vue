<template>
    <div class="fixed inset-0 flex items-center justify-center z-10">
        ...
        <template v-for="(barangay, index) in [details.barangay1, details.barangay2, details.barangay3]" :key="index">
            ...
            <div class="flex justify-center mt-8 gap-4">
                <button @click="navigateToMandatoryReqMPL(detail_id)" class="w-auto px-4 py-2 bg-green-800 text-white rounded-md hover:bg-green-300 hover:text-black">Next</button>
  ...
  export default { 
    ...
    methods: {
        ...
        navigateToMandatoryReqMPL(detail_id) {
