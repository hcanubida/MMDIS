<template>
  <div class="flex w-full">
    ...
    <div class="relative flex flex-col bg-white text-gray-700 w-6/12 p-4">
      <div class="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <!-- Text Section -->
        <div>
          <h6 class="font-semibold text-blue-gray-900">Accomplishment Report</h6>
          <p class="text-sm text-gray-700">for year <span id="release-year">{{ year }}</span></p>
        </div>
      </div>
      <!-- Bar Chart Section -->
      <div class="pt-6">
  ...
  <div class="flex justify-end p-2 relative shadow-md">
