<template>
    <div>
      <div class="flex justify-end mt-1 mr-3 items-center h-12">
        <button @click="showModal = true" class="text-dark bg-orange-200 hover:bg-red-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm pl-4 pr-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center">Add Data<img class="w-4 m-2" src="../../assets/icons/plus.png"></button>
      </div>
              ...
              <div class="sm:flex sm:items-start">
                <div class="mt-3 text-center sm:mt-0 sm:text-left">
                  <div class="mt-2 flex justify-between">
                    <p class="-mr-32">Work Program<br>Term and Conditions<br>Requirements of:<br>(Field Monitoring)</p>
                    <textarea type="text" class="w-72 bg-orange-100 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                  </div>
                  <div class="mt-2 flex justify-between">
                  ...
                  <div class="mt-2 flex justify-between">
                    <p class="mr-5">Upload Map (.jpeg):</p>
                    <input type="file" class="w-72 bg-orange-100 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                  </div>
                </div>
              </div>
